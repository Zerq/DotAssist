...
eval("__webpack_require__.r(__webpack_exports__);\n// extracted by mini-css-extract-plugin\n\n\n//# sourceURL=webpack://asp.net/./src/home/index.css?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   DialogResults: () => (/* binding */ DialogResults),\n/* harmony export */   DotNetDialog: () => (/* binding */ DotNetDialog)\n/* harmony export */ });\n/* harmony import */ var _AppPipe__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../AppPipe */ \"./src/home/AppPipe.ts\");\n/* harmony import */ var _DotNetService__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./DotNetService */ \"./src/home/Components/DotNetDialog/DotNetService.ts\");\n\n\nvar DialogResults;\n(function (DialogResults) {\n    DialogResults[DialogResults[\"Yes\"] = 0] = \"Yes\";\n    DialogResults[DialogResults[\"No\"] = 1] = \"No\";\n    DialogResults[DialogResults[\"Ok\"] = 2] = \"Ok\";\n    DialogResults[DialogResults[\"Next\"] = 3] = \"Next\";\n    DialogResults[DialogResults[\"Complete\"] = 4] = \"Complete\";\n    DialogResults[DialogResults[\"Abort\"] = 5] = \"Abort\";\n    DialogResults[DialogResults[\"Cancel\"] = 6] = \"Cancel\";\n    DialogResults[DialogResults[\"Back\"] = 7] = \"Back\";\n})(DialogResults || (DialogResults = {}));\nclass DotNetDialog extends HTMLElement {\n    adoptedCallback() {\n    }\n    disconnectedCallback() {\n    }\n    static get observedAttributes() {\n        return [];\n    }\n    attributeChangedCallback(name, oldValue, newValue) {\n    }\n    connectedCallback() {\n        this.render();\n    }\n    get DialogResult() {\n        return this.dialogResult;\n    }\n    set DialogResult(value) {\n        this.dialogResult = value;\n        _AppPipe__WEBPACK_IMPORTED_MODULE_0__.App.Pipe.SendEvent(\"dialogResultSet\", value);\n    }\n    async ShowDialogAsync() {\n        this.querySelector(\"dialog\").showModal();\n        return new Promise((resolve, reject) => {\n            _AppPipe__WEBPACK_IMPORTED_MODULE_0__.App.Pipe.Register(\"dialogResultSet\", n => {\n                resolve(n);\n                this.querySelector(\"dialog\").close();\n            });\n        });\n    }\n    async render() {\n        const templates = await _AppPipe__WEBPACK_IMPORTED_MODULE_0__.App.Pipe.Get(_DotNetService__WEBPACK_IMPORTED_MODULE_1__.DotNetCLIService).GetTemplates();\n        _AppPipe__WEBPACK_IMPORTED_MODULE_0__.Elm.From(this).Swallow(() => [\n            new _AppPipe__WEBPACK_IMPORTED_MODULE_0__.Elm(\"dialog\").Swallow(() => [\n                new _AppPipe__WEBPACK_IMPORTED_MODULE_0__.Elm(\"div\").EatArray(templates, n => new _AppPipe__WEBPACK_IMPORTED_MODULE_0__.Elm(\"div\").Class(\"group\").Swallow(() => [\n                    new _AppPipe__WEBPACK_IMPORTED_MODULE_0__.Elm(\"div\").Text(n.Name),\n                    new _AppPipe__WEBPACK_IMPORTED_MODULE_0__.Elm(\"div\").Text(n.FullName),\n                    new _AppPipe__WEBPACK_IMPORTED_MODULE_0__.Elm(\"div\").EatArray(n.Languages, n => new _AppPipe__WEBPACK_IMPORTED_MODULE_0__.Elm(\"span\").Text(n))\n                ]))\n            ])\n        ]);\n    }\n}\n\n\n//# sourceURL=webpack://asp.net/./src/home/Components/DotNetDialog/DotNetDialog.ts?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   FileView: () => (/* binding */ FileView)\n/* harmony export */ });\n/* harmony import */ var _AppPipe__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../AppPipe */ \"./src/home/AppPipe.ts\");\n/* harmony import */ var _FileSystem__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../FileSystem */ \"./src/home/FileSystem.ts\");\n/* harmony import */ var _PathType__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../PathType */ \"./src/home/PathType.ts\");\n/* harmony import */ var _RenderDirectories__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./RenderDirectories */ \"./src/home/Components/FileViewer/RenderDirectories.ts\");\n/* harmony import */ var _RenderDrives__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./RenderDrives */ \"./src/home/Components/FileViewer/RenderDrives.ts\");\n/* harmony import */ var _RenderFiles__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./RenderFiles */ \"./src/home/Components/FileViewer/RenderFiles.ts\");\n/* harmony import */ var _RenderParent__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./RenderParent */ \"./src/home/Components/FileViewer/RenderParent.ts\");\n\n\n\n\n\n\n\nclass FileView extends HTMLElement {\n    constructor() {\n        super();\n    }\n    adoptedCallback() {\n        // called when the element is moved to a new document\n        // (happens in document.adoptNode, very rarely used)\n    }\n    disconnectedCallback() {\n        // browser calls this method when the element is removed from the document\n        // (can be called many times if an element is repeatedly added/removed)\n    }\n    static get observedAttributes() {\n        return [\"path\"];\n    }\n    attributeChangedCallback(name, oldValue, newValue) {\n        if (name === \"path\") {\n            const pathItem = _AppPipe__WEBPACK_IMPORTED_MODULE_0__.App.Pipe.Get(_FileSystem__WEBPACK_IMPORTED_MODULE_1__.FileSystem).GetDrives(newValue).then(n => {\n                this.Render(n);\n                _AppPipe__WEBPACK_IMPORTED_MODULE_0__.App.Pipe.SendEvent(\"FilePathChanged\", newValue);\n            });\n        }\n    }\n    connectedCallback() {\n        if (this.hasAttribute(\"path\")) {\n            const newValue = this.getAttribute(\"path\");\n            const pathItem = _AppPipe__WEBPACK_IMPORTED_MODULE_0__.App.Pipe.Get(_FileSystem__WEBPACK_IMPORTED_MODULE_1__.FileSystem).GetDrives(newValue).then(n => {\n                this.Render(n);\n            });\n        }\n    }\n    async Render(dir) {\n        this.innerHTML = \"\";\n        this.appendChild(new _AppPipe__WEBPACK_IMPORTED_MODULE_0__.Elm(\"div\").Text(dir.FullPath.toUpperCase()).Class(\"PathDisplay\").done());\n        if (dir.PathType === _PathType__WEBPACK_IMPORTED_MODULE_2__.PathType.Drive) {\n            (0,_RenderDrives__WEBPACK_IMPORTED_MODULE_4__.RenderDrives)(dir.Drives, this);\n            (0,_RenderDirectories__WEBPACK_IMPORTED_MODULE_3__.RenderDirectories)(dir.Directories, this);\n            (0,_RenderFiles__WEBPACK_IMPORTED_MODULE_5__.RenderFiles)(dir.Files, this);\n        }\n        else {\n            //render parent\n            (0,_RenderParent__WEBPACK_IMPORTED_MODULE_6__.RenderParent)(dir.Parent, this);\n            (0,_RenderDirectories__WEBPACK_IMPORTED_MODULE_3__.RenderDirectories)(dir.Directories, this);\n            (0,_RenderFiles__WEBPACK_IMPORTED_MODULE_5__.RenderFiles)(dir.Files, this);\n        }\n    }\n}\n\n\n//# sourceURL=webpack://asp.net/./src/home/Components/FileViewer/FileView.ts?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   RenderDirectories: () => (/* binding */ RenderDirectories)\n/* harmony export */ });\n/* harmony import */ var _AppPipe__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../AppPipe */ \"./src/home/AppPipe.ts\");\n/* harmony import */ var _Assets__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../Assets */ \"./src/home/Assets.ts\");\n\n\nconst RenderDirectories = (directories, fileView) => {\n    _AppPipe__WEBPACK_IMPORTED_MODULE_0__.Elm.From(fileView).EatArray(directories, n => new _AppPipe__WEBPACK_IMPORTED_MODULE_0__.Elm(\"div\").Class(\"group\", \"dir\").Evt(\"click\", () => {\n        fileView.setAttribute(\"path\", n.FullPath);\n    }).Swallow(() => [\n        new _AppPipe__WEBPACK_IMPORTED_MODULE_0__.Elm(\"div\").Swallow(() => [\n            new _AppPipe__WEBPACK_IMPORTED_MODULE_0__.Elm(\"img\").Attr(\"src\", _Assets__WEBPACK_IMPORTED_MODULE_1__.Assets.Folder)\n        ]),\n        new _AppPipe__WEBPACK_IMPORTED_MODULE_0__.Elm(\"div\").Text(`${n.Name}`)\n    ]));\n};\n\n\n//# sourceURL=webpack://asp.net/./src/home/Components/FileViewer/RenderDirectories.ts?");

/***/ }),

/***/ "./src/home/Components/FileViewer/RenderDrives.ts":
/*!********************************************************!*\
  !*** ./src/home/Components/FileViewer/RenderDrives.ts ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   RenderDrives: () => (/* binding */ RenderDrives)\n/* harmony export */ });\n/* harmony import */ var _AppPipe__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../AppPipe */ \"./src/home/AppPipe.ts\");\n/* harmony import */ var _Assets__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../Assets */ \"./src/home/Assets.ts\");\n/* harmony import */ var _formatSize__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./formatSize */ \"./src/home/Components/FileViewer/formatSize.ts\");\n\n\n\nconst RenderDrives = (drives, fileView) => {\n    _AppPipe__WEBPACK_IMPORTED_MODULE_0__.Elm.From(fileView).EatArray(drives, n => new _AppPipe__WEBPACK_IMPORTED_MODULE_0__.Elm(\"dir\").Class(\"group\", \"dir\").Evt(\"click\", () => {\n        fileView.setAttribute(\"path\", n.FullPath);\n    }).Swallow(() => [\n        new _AppPipe__WEBPACK_IMPORTED_MODULE_0__.Elm(\"div\").Swallow(() => [\n            new _AppPipe__WEBPACK_IMPORTED_MODULE_0__.Elm(\"img\").Attr(\"src\", _Assets__WEBPACK_IMPORTED_MODULE_1__.Assets.Folder)\n        ]),\n        new _AppPipe__WEBPACK_IMPORTED_MODULE_0__.Elm(\"div\").Text(`${n.Name}`),\n        new _AppPipe__WEBPACK_IMPORTED_MODULE_0__.Elm(\"div\").Text(n.Description ?? \"\"),\n        new _AppPipe__WEBPACK_IMPORTED_MODULE_0__.Elm(\"div\").Text((0,_formatSize__WEBPACK_IMPORTED_MODULE_2__.formatSize)(n.Size)),\n    ]));\n};\n\n\n//# sourceURL=webpack://asp.net/./src/home/Components/FileViewer/RenderDrives.ts?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   RenderFiles: () => (/* binding */ RenderFiles)\n/* harmony export */ });\n/* harmony import */ var _AppPipe__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../AppPipe */ \"./src/home/AppPipe.ts\");\n/* harmony import */ var _Assets__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../Assets */ \"./src/home/Assets.ts\");\n/* harmony import */ var _formatSize__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./formatSize */ \"./src/home/Components/FileViewer/formatSize.ts\");\n\n\n\nconst RenderFiles = (files, fileView) => {\n    _AppPipe__WEBPACK_IMPORTED_MODULE_0__.Elm.From(fileView).EatArray(files, n => new _AppPipe__WEBPACK_IMPORTED_MODULE_0__.Elm(\"dir\").Class(\"group\").Swallow(() => [\n        new _AppPipe__WEBPACK_IMPORTED_MODULE_0__.Elm(\"div\").Swallow(() => [\n            new _AppPipe__WEBPACK_IMPORTED_MODULE_0__.Elm(\"img\").Attr(\"src\", !_Assets__WEBPACK_IMPORTED_MODULE_1__.FileLookUp.has(n.Extension) ? _Assets__WEBPACK_IMPORTED_MODULE_1__.Assets.File : _Assets__WEBPACK_IMPORTED_MODULE_1__.FileLookUp.get(n.Extension))\n        ]),\n        new _AppPipe__WEBPACK_IMPORTED_MODULE_0__.Elm(\"div\").Text(n.Name),\n        new _AppPipe__WEBPACK_IMPORTED_MODULE_0__.Elm(\"div\"),\n        new _AppPipe__WEBPACK_IMPORTED_MODULE_0__.Elm(\"div\").Text((0,_formatSize__WEBPACK_IMPORTED_MODULE_2__.formatSize)(n.Size)),\n    ]));\n};\n\n\n//# sourceURL=webpack://asp.net/./src/home/Components/FileViewer/RenderFiles.ts?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _index_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.css */ \"./src/home/index.css\");\n/* harmony import */ var _Home__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Home */ \"./src/home/Home.ts\");\n/* harmony import */ var _Components_AppMenu_AppMenu__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Components/AppMenu/AppMenu */ \"./src/home/Components/AppMenu/AppMenu.ts\");\n/* harmony import */ var _Components_FileViewer_FileView__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Components/FileViewer/FileView */ \"./src/home/Components/FileViewer/FileView.ts\");\n/* harmony import */ var _AppPipe__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./AppPipe */ \"./src/home/AppPipe.ts\");\n/* harmony import */ var _FileSystem__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./FileSystem */ \"./src/home/FileSystem.ts\");\n/* harmony import */ var _Components_DotNetDialog_DotNetService__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Components/DotNetDialog/DotNetService */ \"./src/home/Components/DotNetDialog/DotNetService.ts\");\n/* harmony import */ var _Components_DotNetDialog_DotNetDialog__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./Components/DotNetDialog/DotNetDialog */ \"./src/home/Components/DotNetDialog/DotNetDialog.ts\");\n\n\n\n\n\n\n\n\n(function () {\n    _AppPipe__WEBPACK_IMPORTED_MODULE_4__.App.Pipe.Set(_FileSystem__WEBPACK_IMPORTED_MODULE_5__.FileSystem);\n    _AppPipe__WEBPACK_IMPORTED_MODULE_4__.App.Pipe.Set(_Components_DotNetDialog_DotNetService__WEBPACK_IMPORTED_MODULE_6__.DotNetCLIService);\n    customElements.define(\"file-viewer\", _Components_FileViewer_FileView__WEBPACK_IMPORTED_MODULE_3__.FileView);\n    customElements.define(\"app-menu\", _Components_AppMenu_AppMenu__WEBPACK_IMPORTED_MODULE_2__.AppMenu);\n    customElements.define(\"dotdet-dialog\", _Components_DotNetDialog_DotNetDialog__WEBPACK_IMPORTED_MODULE_7__.DotNetDialog);\n    new _Home__WEBPACK_IMPORTED_MODULE_1__.Home().Run().then(() => {\n        console.log(\"done\");\n    });\n}());\n\n\n//# sourceURL=webpack://asp.net/./src/home/entry.ts?");
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/home/entry.ts");
/******/ 	
/******/ })()
;